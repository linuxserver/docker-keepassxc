pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'KEEPASSXC_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-keepassxc'
    CONTAINER_NAME = 'keepassxc'
    DOCKERHUB_IMAGE = 'linuxserver/keepassxc'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/keepassxc'
    PR_DOCKERHUB_IMAGE = 'lspipepr/keepassxc'
    DIST_IMAGE = 'alpine'
    DIST_TAG = '3.20'
    DIST_REPO = 'http://dl-cdn.alpinelinux.org/alpine/v3.20/community/'
    DIST_REPO_PACKAGES = 'keepassxc'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    CI_PORT = '3000'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-keepassxc/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-keepassxc\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-keepassxc\" \
          ...
          --label \"org.opencontainers.image.description=[KeePassXC](https://keepassxc.org/) is a free and open-source password manager. It started as a community fork of KeePassX (itself a cross-platform port of KeePass).\" \
